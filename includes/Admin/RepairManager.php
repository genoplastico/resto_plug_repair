...
class RepairManager {
    public function __construct() {
        // Removemos la acción que crea el menú duplicado
        // add_action('admin_menu', [$this, 'add_repairs_menu']); // Esta línea se elimina
    ...
    public function get_client_appliances() {
        ...
        if (!isset($_POST['client_id'])) {
            wp_send_json_error(['message' => __('Client ID is required.', 'appliance-repair-manager')]);
            return;
        }
        ...
        if ($appliances === false) {
            wp_send_json_error([
                'message' => __('Database error while fetching appliances.', 'appliance-repair-manager'),
    ...
    public function handle_add_note_ajax() {
        ...
        wp_send_json_success(['message' => __('Note added successfully.', 'appliance-repair-manager')]);
    }
